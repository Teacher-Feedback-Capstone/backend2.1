...
class grader:
    ...
    def evaluate(self, subject ,user_input):
        # Define the prompt template
        print(f"SUBJECT: {subject}")
        prompt_template = PromptTemplate(
            input_variables=["subject", "user_input"],
            template=(
        ...
        # Invoke the chain
        result = chain.invoke({"subject": subject, "user_input": user_input})
...
if __name__ == "__main__":
    ...
    if not user_input.strip():
        ...
        try:
            ...
            feedback = grader.evaluate(subject, user_input)
            print("\nEvaluation Result:")
            print(feedback)
